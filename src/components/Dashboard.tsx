        ...
        <div className="min-h-screen bg-[#0a0a0a] text-gray-300 p-6 font-mono selection:bg-blue-500 selection:text-white">
            <header className="max-w-6xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                            type="text" 
                            placeholder="Filter by URL, Method, Source..." 
                            className="pl-10 pr-4 py-2 bg-[#1a1a1a] border border-gray-800 rounded-lg focus:outline-none focus:border-blue-500 w-64 text-sm transition-all"
                            value={search}
            ...
            <main className="max-w-6xl mx-auto">
                <div className="bg-[#141414] border border-gray-800 rounded-xl overflow-hidden shadow-2xl">
                    <div className="grid grid-cols-[80px_100px_1fr_80px_100px_40px] gap-4 px-6 py-3 bg-[#1a1a1a] border-b border-gray-800 text-xs font-bold text-gray-500 uppercase tracking-widest">
                        <span>Method</span>
                        <span>Source</span>
                        <span>Route / URL</span>
                        <span>Status</span>
                            ...
                            <AnimatePresence initial={false}>
                                {filteredLogs.map((log) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <span className={`text-xs font-bold px-2 py-1 rounded inline-block text-center border ${
                                                log.method === 'GET' ? 'text-blue-400 bg-blue-400/10 border-blue-400/20' : 
                                            ...
                                            <div className="flex items-center gap-1.5 overflow-hidden">
                                                ...
                                                <span className="text-[10px] uppercase font-bold text-gray-500">{getSourceLabel(log.source)}</span>
                                            </div>
                                            ...
                                            <div>
                                                <span className={`text-xs px-2 py-0.5 rounded border ${getStatusColor(log.status)}`}>
                                                    {log.status}
                                                </span>
                                            </div>
                                                ...
                                                >
                                                    <div className="p-6">
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            <div>
                                                                <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 flex items-center gap-2">Full URL</h4>
                                                                <div className="p-3 bg-black/40 border border-gray-800 rounded-lg text-xs break-all text-blue-300">
                                                                    {log.url}
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 flex items-center gap-2">Metadata</h4>
                                                                <div className="grid grid-cols-2 gap-4 text-xs">
                                                                    <div className="p-3 bg-black/40 border border-gray-800 rounded-lg">
                                                                        <span className="block text-gray-600 mb-1">Status Code</span>
                                                                        <span className={`font-bold ${log.status >= 400 ? 'text-red-400' : 'text-green-400'}`}>{log.status}</span>
                                                                    </div>
                                                                    <div className="p-3 bg-black/40 border border-gray-800 rounded-lg">
                                                        ...
                                                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-[11px]">
                                                            <div>
                                                                <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 text-purple-500">Request Body</h4>
                                                                <pre className="p-4 bg-black/40 border border-gray-800 rounded-lg overflow-x-auto text-purple-300 max-h-[300px] overflow-y-auto">
                                                                    {formatJson(log.requestBody)}
                                                                </pre>
                                                            </div>
                                                            <div>
                                                                <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 text-orange-500">Response Body</h4>
                                                                <pre className="p-4 bg-black/40 border border-gray-800 rounded-lg overflow-x-auto text-orange-300 max-h-[300px] overflow-y-auto">
